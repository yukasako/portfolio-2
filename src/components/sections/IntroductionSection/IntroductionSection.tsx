      ...
      <article id='introduction' className={style.introduction}>
        ...
        <div className={style.text}>
          ...
          <p>
            ...
            higher vocational education institution in Sweden. While studying, I
            worked as a front-end developer intern at Triggerbee, contributing
            to UI/UX development and user-facing features.
          </p>
          ...
          <p>
            ...
            Frontend development and comic creation are very similar to me. Both
            involve visualising ideas by considering the perspectives of users
            or readers. Both require concentration, persistence and patience,
            and it brings great joy of creating. Skaparglädje is my key word,
            and I aspire to make such work my livelihood.
          </p>
        </div>
      </article>
    </>
